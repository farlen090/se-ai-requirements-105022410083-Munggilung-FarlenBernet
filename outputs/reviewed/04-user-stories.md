...
| :--- | :---: | :--- |
| **Konsistensi Aktor** | **PASSED** | Frasa aktor menggunakan nomenklatur standar yang seragam: *Lecturer*, *Student*, dan *Administrator*. |
| **Struktur Berorientasi Pengguna** | **PASSED** | Seluruh cerita mengikuti templat baku rekayasa kebutuhan: *As a... I want to... So that...* |
| **Kriteria Penerimaan Terukur** | **PASSED** | Setiap *User Story* didukung minimal oleh 2 *Acceptance Criteria* biner yang dapat diverifikasi secara mekanis melalui pengujian fungsional. |
| **Kepatuhan Fakta Proyek** | **PASSED** | Alur pengerjaan cerita pengguna murni menguraikan hak operasional yang tertulis di dokumen dasar inisiasi tanpa memasukkan fitur spekulatif di luar ruang lingkup kelas. |
